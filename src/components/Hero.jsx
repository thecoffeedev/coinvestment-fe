            ...
            <div className='max-w-5xl h-full mx-auto '>
                <div className='flex h-fit justify-between w-full px-2'>
                    ...
                    <div className='flex font-extralight items-center text-[1rem] space-x-8'>
                        <a className='opacity-60 hover:opacity-100' href="/"><p>Available Bundle</p></a>
                        <a className='opacity-60 hover:opacity-100' href="/"><p>Why Coinvestment</p></a>
                        <a className='opacity-60 hover:opacity-100' href="/"><p>FAQ</p></a>
                        <a className='opacity-60 hover:opacity-100' href="/"><p>Resources</p></a>
                    </div>
                </div>
                ...
                <div className='text-center space-y-3'>
                    ...
                    <p className='text-lg font-extralight'>One click. Dozens of cryptos. Zero service fees.</p>
                </div>
            </div>
        </div>
    )
