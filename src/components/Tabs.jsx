...
function Tabs() {
  ...
  return (
    <div className="w-full h-12 flex flex-row align-middle gap-6 pl-4">
      <button
        className={`rounded-full px-3 py-1 my-auto h-fit ${currentPage === "crypto"
      ...
      <button
        className={`rounded-full px-3 py-1 my-auto h-fit ${currentPage === "bundles"
          ? "bg-primaryPurple text-white"
          : "bg-primaryLight border border-primaryPurple"
          }`}
      ...
      <button
        className={`rounded-full px-3 py-1 my-auto h-fit ${currentPage === "account"
          ? "bg-primaryPurple text-white"
          : "bg-primaryLight border border-primaryPurple"
          }`}
